		...
		<div id="container">
			...
			<div class="content">
				<dl class="company_center_content">
					<dt>
						<h1>
							<em></em> 待处理简历 <span>（共${count}份）</span>
						</h1>
					</dt>
					<dd>
						<form>
										...
										<div class="resumeShow">
											...
											<div class="links">
												<a data-deliverid="1686182" class="resume_caninterview"
													href="deliverystatus.action?deliveryid=${listDelivery.deliveryid}&status=1&flag=0">待定</a> <a
													...
													href="deliverystatus.action?deliveryid=${listDelivery.deliveryid}&status=3&flag=0">不合适</a>
												</a>
											</div>
										</div>
							...
							<c:if test="${experience == '不限' && education == '不限'}">
								<div style="float:right;margin-right:40px;">
									<itcast:page url="caninterviewresumes.action"  />
								</div>
							</c:if>
							<c:if test="${experience != '不限' || education != '不限'}">
								<div style="float:right;margin-right:40px;">
									<itcast:page url="caninterviewresumestiaojian.action" />
								</div>
							</c:if>
						</form>
...
<script type="text/javascript">
	function interview(deliveryid) {  	
		//alert(deliveryid)
		window.location.href = "deliverystatus.action?deliveryid="+deliveryid+"&status=2&flag=0"; 
...
<script type="text/javascript">
	function tiaojian(one,two) {  	
		...
		window.location.href = "caninterviewresumestiaojian.action?realexperiencestart="+realexperiencestart+"&realexperienceend="+realexperienceend+"&realeducation="+realeducation+""; 
		window.event.returnValue=false;  
	}
</script>
</html>