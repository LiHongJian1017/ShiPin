						...
						<form id="searchForm">
							...
							<c:forEach items="${page.rows}" var="listPosition">
									<li data-id="">
										...
										<div class="links">
											<a class="job_refresh" href="npositions.action">刷新<span>每个职位7天内只能刷新一次</span></a>
											<a class="job_edit" href="getpositiondetail.action?positionid=${listPosition.positionid}&status=${listPosition.status}">编辑</a>
											<a class="" href="ndeleteposition.action?positionid=${listPosition.positionid}&status=${listPosition.status}">删除</a>
										</div>
									</li>
								</c:forEach>
							</ul>
