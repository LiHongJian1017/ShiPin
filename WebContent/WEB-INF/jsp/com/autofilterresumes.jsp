...
<meta name="keywords"
	content="师聘,师聘网,师聘招聘,师聘, 师聘网 ,互联网招聘,师聘互联网招聘, 移动互联网招聘, 垂直互联网招聘, 微信招聘, 微博招聘, 师聘官网, 师聘百科,跳槽, 高薪职位, 互联网圈子, IT招聘, 职场招聘, 猎头招聘,O2O招聘, LBS招聘, 社交招聘, 校园招聘, 校招,社会招聘,社招">
		...
		<div id="container">
			...
			<div class="content">
				<dl class="company_center_content">
					<dt>
						<h1>
							<em></em> 自动过滤简历 <span>（共${count}份）</span>
						</h1>
					</dt>
					<dd>
						<form>
							<div class="filter_tip">
								系统将自动过滤学历、城市、工作年限 <span>不符合</span> 要求的简历。 <span> &nbsp;</span>
								 &nbsp;
							</div>
							<br>
							...
							<!-- end .filter_options -->
							<c:forEach items="${page.rows}" var="listDelivery">
										...
										<div class="resumeShow">
											...
											<div class="links">
												<a data-deliverid="1686182" class="resume_caninterview"
													href="deliverystatus.action?deliveryid=${listDelivery.deliveryid}&status=1&flag=4">待定</a> <a
													href="Mailto:${listDelivery.email}" onclick="interview('${listDelivery.deliveryid}');">通知面试</a> <a
													data-deliverid="1686182" class="resume_refuse"
													href="deliverystatus.action?deliveryid=${listDelivery.deliveryid}&status=3&flag=4">不合适</a>
												</a>
											</div>
										</div>
							...
							<c:if test="${experience == '不限' && education == '不限'}">
								<div style="float:right;margin-right:40px;">
									<itcast:page url="autofilterresumes.action"  />
								</div>
							</c:if>
							<c:if test="${experience != '不限' || education != '不限'}">
								<div style="float:right;margin-right:40px;">
									<itcast:page url="autofilterresumestiaojian.action" />
								</div>
							</c:if>
							<!-- end .resumeLists -->
						</form>
...
<script type="text/javascript">
	function interview(deliveryid) {  	
		//alert(deliveryid)
		window.location.href = "deliverystatus.action?deliveryid="+deliveryid+"&status=2&flag=4"; 
...
<script type="text/javascript">
	function tiaojian(one,two) {  	
		...
		window.location.href = "autofilterresumestiaojian.action?realexperiencestart="+realexperiencestart+"&realexperienceend="+realexperienceend+"&realeducation="+realeducation+""; 
		window.event.returnValue=false;  
	}
</script>
<!-- <script type="text/javascript">
	function tiaojian(one,two) {  	
		alert(one+" "+two)
		window.location.href = "autofilterresumestiaojian.action?experience="+one+"&education="+two+""; 
		window.event.returnValue=false;  
	}
</script> -->
</html>