		...
		<div id="container">
			...
			<div class="content">
				<dl class="company_center_content">
					<dt>
						<h1>
							<em></em> 可看简历职位 <span>（共<i style="color: #fff; font-style: normal" id="positionNumber">${count}</i>个）</span>
						</h1>
					</dt>
					<dd>
						<form id="searchForm">
							...
							<ul class="reset my_jobs">
								<c:forEach items="${page.rows}" var="listPosition">
									<li data-id="">
										...
										<div class="links">
											<a class="" href="lianhepositionjianli.action?positionid=${listPosition.positionid}&page=1">查看适合简历</a> 
											<%-- 
											<a class="job_refresh" href="ypositions.action">刷新</a>
											<a class="" href="offlinelianheposition.action?positionid=${listPosition.positionid}">下线</a> 
											<a class="" href="ydeletelianheposition.action?positionid=${listPosition.positionid}&status=${listPosition.status}">删除</a>
										 	--%>
										 </div>
									</li>
								</c:forEach>
						...
						<div style="float:right;margin-right:40px;">
							<itcast:page url="ylianhepositions.action"  />
						</div>
					</dd>
				</dl>
