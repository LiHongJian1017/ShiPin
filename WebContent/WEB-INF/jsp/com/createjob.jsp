		...
		<div id="header">
			<div class="wrapper">
				...
				<ul id="navheader" class="reset">
					...
					<li class="current"><a href="createjob.action">发布的职位</a></li>
					...
					<c:if test="${info=='0'}">
						...
						<form action="createposition.action"
							...
							<table class="btm">
								<tbody>
									<tr>
										<input type="hidden" id="companyid" value="1" name="companyid">
									...
									<tr>
										...
										<td>
											<ul class="profile_radio clearfix reset">
												<li class="current" >全职<em></em> <input type="radio" name="positionnature" checked="checked" id="positionnature"
													value="全职">
												</li>
												<li>兼职<em></em> <input type="radio" name="positionnature" id="positionnature"
													value="兼职">
												</li>
												<li>实习<em></em> <input type="radio" name="positionnature" id="positionnature"
													value="实习">
												</li>
											</ul>
										</td>
...
<script type="text/javascript">
        function test(){
            var radios = document.getElementsByName("jobNature");
            var value = 0;
