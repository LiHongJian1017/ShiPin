		...
		<div id="container">
			...
			<div class="content">
				<dl class="company_center_content">
					<dt>
						<h1>
							<em></em> 不合适简历 <span>（共${count}份）</span>
						</h1>
					</dt>
					<dd>
						<form>
										...
										<div class="resumeShow">
											...
											<div class="links">
												<a
													...
													href="deliverystatus.action?deliveryid=${listDelivery.deliveryid}&status=5&flag=3">删除</a>
												</a>
											</div>
										</div>
							...
							<c:if test="${experience == '不限' && education == '不限'}">
								<div style="float:right;margin-right:40px;">
									<itcast:page url="haverefuseresumestiaojian.action"  />
								</div>
							</c:if>
							<c:if test="${experience != '不限' || education != '不限'}">
								<div style="float:right;margin-right:40px;">
...
<script type="text/javascript">
	function tiaojian(one,two) {  	
		...
		window.location.href = "haverefuseresumestiaojian.action?realexperiencestart="+realexperiencestart+"&realexperienceend="+realexperienceend+"&realeducation="+realeducation+""; 
