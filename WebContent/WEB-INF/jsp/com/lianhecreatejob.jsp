		...
		<div id="container">
			...
			<div class="sidebar">
				...
				<div class="subscribe_side mt20">
					<div class="f14">联合职位？</div>
					<div class="f18 mb10">联合职位通过后可以查看符合职位信息的简历!</div>
					<div>
						咨询：<a class="f16" href="mailto:jessica@lagou.com">jessica@shipin.com</a>
					</div>
			...
			<div class="content">
				<dl class="company_center_content">
					...
					<c:if test="${info=='0'}">
						...
						<form action="createlianheposition.action"
