...
<title>发布新职位-招聘服务-师聘网-最专业的互联网招聘平台</title>
		...
		<div id="header">
			<div class="wrapper">
				...
				<ul id="navheader" class="reset">
					...
					<li><a href="comjob.action">发布的职位</a></li>
			...
			<div class="content">
				<dl class="company_center_content">
					...
					<dd>
						...
						<form action="editposition.action"
							...
							<table class="btm">
								<tbody>
									<tr>
										...
										<input type="hidden" id="positionid" value="${position.positionid}" name="positionid">
										<input type="hidden" id="status" value="${position.status}" name="status">
										<td width="85">职位类别</td>
										<td><input type="hidden" id="positiontype" value="${position.positiontype}"
											name="positiontype"> <input type="button"
											value="${position.positiontype}" id="select_category"
									...
									<tr>
										...
										<td>职位名称</td>
										<td><input type="text" placeholder="请输入职位名称，如：教师"
											value="${position.positionname}" name="positionname" id="positionname"></td>
									</tr>
									<!--  
									<tr>
										<td></td>
										<td>所属类型</td>
										<td><input type="text" placeholder="请输入所属类型 如:" value=""
							...
							<table class="btm">
								<tbody>
									<tr>
										...
										<td>
											<ul class="profile_radio clearfix reset">
												<li id="radio1" >全职<em></em> <input type="radio" name="positionnature" checked="checked" id="positionnature"
													value="全职">
												</li>
									...
									<tr>
										...
										<td>
											<div class="salary_range">
												<div>
													<input type="text" placeholder="最低月薪" value="${position.salarymin}"
														id="salarymin" name="salarymin"> <span>k</span>
												</div>
												<div>
													<input type="text" placeholder="最高月薪" value="${position.salarymax}"
                                	...
                                	<td>工作城市</td>
                                	<td>
                                    	<input type="text" placeholder="请输入工作城市，如：北京" name="workaddress" id="workaddress" value="${position.workaddress}">
                                    </td>
                                </tr>
								</tbody>
							</table>
								...
								<tbody>
									<tr>
										...
										<td>
											<c:if test="${position.experience == '-1'}">
												<input type="hidden" id="experience" value="不限" name="experience">
												<input type="button" value="不限" id="select_experience" class="selectr selectr_380">
											</c:if>
											<c:if test="${position.experience == '0'}">
												<input type="hidden" id="experience" value="应届毕业生" name="experience">
												<input type="button" value="应届毕业生" id="select_experience" class="selectr selectr_380">
											</c:if>
											<c:if test="${position.experience == '1'}">
												<input type="hidden" id="experience" value="1年" name="experience">
												<input type="button" value="1年" id="select_experience" class="selectr selectr_380">
											</c:if>
											<c:if test="${position.experience == '2'}">
												<input type="hidden" id="experience" value="2年" name="experience">
												<input type="button" value="2年" id="select_experience" class="selectr selectr_380">
											</c:if>
											<c:if test="${position.experience == '3'}">
												<input type="hidden" id="experience" value="3年" name="experience">
												<input type="button" value="3年" id="select_experience" class="selectr selectr_380">
											</c:if>
											<c:if test="${position.experience == '4'}">
												<input type="hidden" id="experience" value="4年" name="experience">
												<input type="button" value="4年" id="select_experience" class="selectr selectr_380">
											</c:if>
											<c:if test="${position.experience == '5'}">
												<input type="hidden" id="experience" value="5年" name="experience">
												<input type="button" value="5年" id="select_experience" class="selectr selectr_380">
											</c:if>
											<c:if test="${position.experience == '6'}">
												<input type="hidden" id="experience" value="6年" name="experience">
												<input type="button" value="6年" id="select_experience" class="selectr selectr_380">
											</c:if>
											<c:if test="${position.experience == '7'}">
												<input type="hidden" id="experience" value="7年" name="experience">
												<input type="button" value="7年" id="select_experience" class="selectr selectr_380">
											</c:if>
											<c:if test="${position.experience == '8'}">
												<input type="hidden" id="experience" value="8年" name="experience">
												<input type="button" value="8年" id="select_experience" class="selectr selectr_380">
											</c:if>
											<c:if test="${position.experience == '9'}">
												<input type="hidden" id="experience" value="9年" name="experience">
												<input type="button" value="9年" id="select_experience" class="selectr selectr_380">
											</c:if>
											<c:if test="${position.experience == '10'}">
												<input type="hidden" id="experience" value="10年" name="experience">
												<input type="button" value="10年" id="select_experience" class="selectr selectr_380">
											</c:if>
											<c:if test="${position.experience == '11'}">
												<input type="hidden" id="experience" value="10年以上" name="experience">
												<input type="button" value="10年以上" id="select_experience" class="selectr selectr_380">
											</c:if>
									...
									<tr>
										...
										<c:if test="${position.education == '0'}">
											<input type="hidden" id="education" value="不限" name="education">
											<input type="button"value="不限" id="select_education" class="selectr selectr_380">
										</c:if>
										<c:if test="${position.education == '1'}">
											<input type="hidden" id="education" value="大专" name="education">
											<input type="button"value="大专" id="select_education" class="selectr selectr_380">
										</c:if>
										<c:if test="${position.education == '2'}">
											<input type="hidden" id="education" value="本科" name="education">
											<input type="button"value="本科" id="select_education" class="selectr selectr_380">
										</c:if>
										<c:if test="${position.education == '3'}">
											<input type="hidden" id="education" value="硕士" name="education">
											<input type="button"value="硕士" id="select_education" class="selectr selectr_380">
										</c:if>
										<c:if test="${position.education == '4'}">
											<input type="hidden" id="education" value="博士" name="education">
											<input type="button"value="博士" id="select_education" class="selectr selectr_380">
										</c:if>
								...
								<tbody>
									<tr>
										...
										<td><input type="text" maxlength="20"
											placeholder="20字描述该职位的吸引力，如：福利待遇、发展前景等" value="${position.positionadvantage}"
									...
									<tr>
										<td><span class="redstar">*</span></td>
										<td>职位描述</td>
										<td><span class="c9 f14">(建议分条描述岗位职责、任职要求等)</span>
											<textarea name="positiondetail" id="positiondetail" placeholder="1、&#10;2、&#10;3、&#10;">${position.positiondetail}</textarea>
									</tr>
									<tr>
										<td><span class="redstar">*</span></td>
										<td>工作地址</td>
										<td><input type="text" placeholder="请输入详细的工作地址" value="${position.positionaddress}"
								...
								<tbody>
									<tr>
										...
										<td colspan="2"><input type="submit"
											value="编辑" id="formSubmit" class="btn_32"></td>
									</tr>
								</tbody>
							</table>
						</form>
...
<script type="text/javascript">
function check(){
	   var positiontype = document.getElementById("positiontype").value.replace(/(^\s*)|(\s*$)/g, "");
	   ...
	   var workaddress = document.getElementById("workaddress").value.replace(/(^\s*)|(\s*$)/g, "");
	   var experience = document.getElementById("experience").value.replace(/(^\s*)|(\s*$)/g, "");
	   var education = document.getElementById("education").value.replace(/(^\s*)|(\s*$)/g, "");
	   var positionadvantage = document.getElementById("positionadvantage").value.replace(/(^\s*)|(\s*$)/g, "");
	   var positiondetail = document.getElementById("positiondetail").value.replace(/(^\s*)|(\s*$)/g, "");
	   var positionaddress = document.getElementById("positionaddress").value.replace(/(^\s*)|(\s*$)/g, "");
	   if(positiontype ==  null || positiontype == '' || positionname ==  null || positionname == '' 
		  || salarymin ==  null || salarymin == '' || salarymax ==  null || salarymax == '' 
		  || workaddress ==  null || workaddress == '' || experience ==  null || experience == '' 
		  || education ==  null || education == '' || positionadvantage ==  null || positionadvantage == '' 
		  || positiondetail ==  null || positiondetail == '' || positionaddress ==  null || positionaddress == ''
		  || !(/(^[1-9]\d*$)/.test(salarymin)) || !(/(^[1-9]\d*$)/.test(salarymax)) 
		  || salarymin>salarymax || salarymax>2*salarymin){
	        return false;
	   }else{
		   return true;
	   }
		...
		gc.getLocation(pt, function(rs){
		   ...
		   var label = new BMap.Label("我的坐标："+em.point.lng + ", " + em.point.lat+"  我的地址："+addComp.province + ", " + addComp.city + ", " + addComp.district + ", " + addComp.street + ", " + addComp.streetNumber,{offset:new BMap.Size(20,-10)});
			// marker.setLabel(label);//新坐标-新地址
			 if(rs){
	 				 var sContent =
					"<div box-sizing: content-box; width: 230px; height: 55px; position: absolute; left: 16px; top: 16px; z-index: 10; overflow: hidden;><p style='width:210px;font:bold 14px/16px arial,sans-serif;margin:0;color:#cc5522;white-space:nowrap;overflow:hidden'>"+addComp.province+"</p>" + 
					"<br><tr><td style='vertical-align:top;width:38px;white-space:nowrap;word-break:keep-all'>"+"地址："+rs.address+"</td></tr>" + 
					"</div>";
...
document.ready=function(){
	   var positionnature = "${position.positionnature}";
