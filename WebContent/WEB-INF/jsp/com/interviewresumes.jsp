		...
		<div id="container">
			...
			<div class="content">
				<dl class="company_center_content">
					<dt>
						<h1>
							<em></em> 待定简历 <span>（共${count}份）</span>
						</h1>
					</dt>
					<dd>
						<form>
								...
								<ul class="reset resumeLists">
									<li data-id="" class="onlineResume">
										<div class="resumeShow">
											...
											<div class="links">
												<a href="Mailto:${listDelivery.email}" onclick="interview('${listDelivery.deliveryid}');">通知面试</a> <a
													data-deliverid="1686182" class="resume_refuse"
													href="deliverystatus.action?deliveryid=${listDelivery.deliveryid}&status=3&flag=1">不合适</a>
												</a>
											</div>
										</div>
							...
							<c:if test="${experience == '不限' && education == '不限'}">
								<div style="float:right;margin-right:40px;">
									<itcast:page url="interviewresumes.action"  />
								</div>
							</c:if>
							<c:if test="${experience != '不限' || education != '不限'}">
								<div style="float:right;margin-right:40px;">
									<itcast:page url="interviewresumestiaojian.action" />
								</div>
							</c:if>
							<!-- end .resumeLists -->
						</form>
...
<script type="text/javascript">
	function interview(deliveryid) {  	
		//alert(deliveryid)
		window.location.href = "deliverystatus.action?deliveryid="+deliveryid+"&status=2&flag=1"; 
...
<script type="text/javascript">
	function tiaojian(one,two) {  	
		...
		window.location.href = "interviewresumestiaojian.action?realexperiencestart="+realexperiencestart+"&realexperienceend="+realexperienceend+"&realeducation="+realeducation+""; 
		window.event.returnValue=false;  
	}
</script>
</html>