		...
		<div id="container">
			...
			<div class="content">
				<dl class="company_center_content">
					<dt>
						<h1>
							<em></em> 已下线职位 <span>（共<i style="color: #fff; font-style: normal" id="positionNumber">${count}</i>个）
							</span>
						</h1>
					</dt>
					<dd>
						<form id="searchForm">
							...
							<c:forEach items="${page.rows}" var="listPosition">
									<li data-id="">
										...
										<div class="links">
											<a class="job_refresh" href="npositions.action">刷新</a>
											<a class="" href="ndeletelianheposition.action?positionid=${listPosition.positionid}&status=${listPosition.status}">删除</a>
										</div>
									</li>
								</c:forEach>
							</ul>
						...
						<div style="float:right;margin-right:40px;">
							<itcast:page url="nlianhepositions.action"  />
						</div>
					</dd>
				</dl>
