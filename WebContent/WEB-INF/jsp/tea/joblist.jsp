...
<title>职位搜索-师聘网-最专业的互联网招聘平台</title>
...
<body onload="current('${workaddress}')">
	<div id="body">
		<div id="header">
			<div class="wrapper">
				<a href="index.action" class="logo"> <img src="style/images/logo.png"
		...
		<div id="container">
			...
			<div class="sidebar">
				...
				<a href="http://www.w3cplus.com/" target="_blank" class="partnersAd">
					...
					alt="w3cplus" />
				</a> <a href="http://www.jq-school.com/" target="_blank" class="partnersAd"> <img
						...
						<li class="odd clearfix">
							<div class="hot_pos_l">
								...
								<span><em class="c7">经验：</em> <c:if
									...
									10年及以上
								</c:if> </span> <span><em class="c7">最低学历：</em> 
								<c:if
