					...
					<dl class="c_delivery">
						...
						<dd>
							<div class="delivery_tabs">
								<ul class="reset">
									<li class="current"><a href="delivery.action">全部</a></li>
							...
							<c:forEach items="${listPosandcomanddel}" var="listPosandcomanddel">
								<ul class="reset my_delivery">
									...
									<c:if test="${listPosandcomanddel.status =='0' || listPosandcomanddel.status =='4'}">
											<a class="btn_showprogress" href="javascript:;"> 投递成功 <i></i></a>
									</c:if>
									<c:if test="${listPosandcomanddel.status =='1'}">
											<a class="btn_showprogress" href="javascript:;"> 通过筛选 <i></i></a>
									</c:if>
									<c:if test="${listPosandcomanddel.status =='2'}">
											<a class="btn_showprogress" href="javascript:;"> 通知面试 <i></i></a>
									</c:if>
									<c:if test="${listPosandcomanddel.status =='3'}">
											<a class="btn_showprogress" href="javascript:;"> 不合适 <i></i></a>
									</c:if>
									<c:if test="${listPosandcomanddel.status =='5'}">
											<a class="btn_showprogress" href="javascript:;"> 失效 <i></i></a>
									</c:if>
										</div>
									<c:if test="${listPosandcomanddel.status =='0' || listPosandcomanddel.status =='4'}">
									...
									<c:if test="${listPosandcomanddel.status =='2'}">
										<div class="progress_status	dn">`
											<ul class="status_list">
												<li class="top">
													<div class="list_body">
														<div>请注意查收邮箱邮件,等待电话和短信,进入面试。</div>
													</div>
												</li>
											</ul>
											<a class="btn_closeprogress" href="javascript:;"></a>
