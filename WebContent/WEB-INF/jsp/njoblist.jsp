		...
		<div id="header">
			<div class="wrapper">
				...
				<ul class="reset" id="navheader">
					...
					<li class="current"><a href="njoblist.action">职位</a></li>
					<li><a href="ncompanylist.action">公司</a></li>
				</ul>
				<ul class="loginTop">
				...
				<div id="search_box">
					<form id="searchForm" name="searchForm" action="list.html"
						...
						<input type="text" id="search_input" name="kd" tabindex="1"
							value="${kd}" placeholder="请输入职位名称，如：教师" /> <input type="hidden"
